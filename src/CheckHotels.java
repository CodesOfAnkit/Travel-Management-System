...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        ...
        String[] hotels = new String[]{"Hilton Hotel", "Jalsa Hotel" ,"Radisson Hotel","Marriot Hotel","Ramada Hotel"," Rambagh Hotel","Vijan Palace","Culchuri Hotel","Guljar Hotel","Robert view Hotel"};

        try
        {
            // set the slide show to those images
            for (int i=0; i<=9; i++){
